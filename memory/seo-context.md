...
|----|--------|-------|----------|--------|---------|
| EX-001 | 🔴 Todo | Write and add meta description to homepage | Critical | — | 2026-03-03 |
| EX-002 | 🔴 Todo | Create /robots.txt file | Critical | — | 2026-03-03 |
| EX-003 | 🔴 Todo | Generate XML sitemap at /sitemap.xml | Critical | — | 2026-03-03 |
| EX-004 | 🔴 Todo | Add canonical tag to homepage | Critical | — | 2026-03-03 |
| EX-005 | 🔴 Todo | Add twitter:card meta tag | Critical | — | 2026-03-03 |
| EX-006 | 🔴 Todo | Create and serve favicon.ico | Critical | — | 2026-03-03 |
| EX-010 | 🔴 Todo | Add all Open Graph tags (parent) | Critical | — | 2026-03-03 |
| EX-011 | 🔴 Todo | Add og:title to homepage | Critical | EX-010 | 2026-03-03 |
| EX-012 | 🔴 Todo | Add og:description to homepage | Critical | EX-010 | 2026-03-03 |
| EX-013 | 🔴 Todo | Source/design OG image (1200×630px) for homepage | Critical | EX-010 | 2026-03-03 |
| EX-014 | 🔴 Todo | Add og:image and og:url tags to homepage | Critical | EX-010 | 2026-03-03 |

### 🟠 High

| ID | Status | Title | Priority | Parent | Created |
|----|--------|-------|----------|--------|---------|
| EX-020 | 🟠 Todo | Rewrite homepage title tag (50–60 chars, keyword-first) | High | — | 2026-03-03 |
| EX-021 | 🟠 Todo | Update charset from windows-1252 to UTF-8 | High | — | 2026-03-03 |
| EX-022 | 🟠 Todo | Add internal navigation links to homepage | High | — | 2026-03-03 |
| EX-030 | 🟠 Todo | Expand homepage content 19 → 500+ words (parent) | High | — | 2026-03-03 |
| EX-031 | 🟠 Todo | Research and define target keywords for homepage | High | EX-030 | 2026-03-03 |
| EX-032 | 🟠 Todo | Write expanded homepage body copy (500+ words) | High | EX-030 | 2026-03-03 |
| EX-033 | 🟠 Todo | Write 3–5 keyword-rich H2 subheadings for homepage | High | EX-030 | 2026-03-03 |
| EX-034 | 🟠 Todo | Write H3 subheadings under each H2 for homepage | High | EX-030 | 2026-03-03 |
| EX-040 | 🟠 Todo | Implement JSON-LD structured data (parent) | High | — | 2026-03-03 |
| EX-041 | 🟠 Todo | Add Organization JSON-LD schema to homepage | High | EX-040 | 2026-03-03 |
| EX-042 | 🟠 Todo | Add WebPage JSON-LD schema to homepage | High | EX-040 | 2026-03-03 |

### 🟡 Medium

| ID | Status | Title | Priority | Parent | Created |
|----|--------|-------|----------|--------|---------|
| EX-050 | 🟡 Todo | Add explicit robots meta tag (index, follow) | Medium | — | 2026-03-03 |
| EX-060 | 🟡 Todo | Add visual content/images to homepage (parent) | Medium | — | 2026-03-03 |
| EX-061 | 🟡 Todo | Source or create hero image for homepage | Medium | EX-060 | 2026-03-03 |
| EX-062 | 🟡 Todo | Add hero image with descriptive alt text to homepage | Medium | EX-060 | 2026-03-03 |
| EX-070 | 🟡 Todo | Add 2–3 relevant authority external links | Medium | — | 2026-03-03 |

## Completed Tickets

| ID | Title | Completed |
|----|-------|-----------|
| AUDIT-001 | SEO audit of example.com | 2026-03-03 |
| AUDIT-002 | Task breakdown of audit findings (24 tasks created) | 2026-03-03 |

## Pending Actions

- [ ] Execute EX-031 first (keyword research) — unblocks title, meta desc, and copy tasks
- [ ] Execute EX-002, EX-003, EX-004, EX-005, EX-006, EX-021 (quick technical wins — independent, no dependencies)
- [ ] Implement the 5 meta title rewrites from previous session in CMS
- [ ] Log baseline CTR from Search Console before going live on meta title changes
- [ ] Fill out `memory/CLAUDE.md` with target keyword data (monthly searches, intent)
- [ ] Add initial strategy to `memory/seo-strategy.md`
- [ ] Review full task backlog: `memory/seo-tasks.md`
