#!/usr/bin/env python3
"""
AI Optimization: Claude LLM Responses pipeline.

Wraps agent.dataforseo.ai_optimization.llm_responses.claude.ClaudeResponses.
Sends a prompt to Claude and returns its response, optionally with web
...
Usage:
    python scripts/pipelines/llm_responses_claude.py --help
    python scripts/pipelines/llm_responses_claude.py live --task '{"user_prompt": "What is the best no-code agency?", "web_search": true}'
...
if __name__ == "__main__":
    run_pipeline(ClaudeResponses, "llm-responses-claude")
