#!/usr/bin/env python3
"""
AI Optimization: Perplexity LLM Responses pipeline.

Wraps agent.dataforseo.ai_optimization.llm_responses.perplexity.PerplexityResponses.
Sends a prompt to Perplexity and returns its response, optionally with web
...
Usage:
    python scripts/pipelines/llm_responses_perplexity.py --help
    python scripts/pipelines/llm_responses_perplexity.py live --task '{"user_prompt": "What is the best no-code agency?"}'
...
if __name__ == "__main__":
    run_pipeline(PerplexityResponses, "llm-responses-perplexity")
